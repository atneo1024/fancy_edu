...
/**
 * @author Joah
 * @time 2020/2/14 20:33
 */
public class VideoController {
    //账号AK信息请填写(必选)
    private static final String accessKeyId = "LTAI4FfQ9EJj5f9AjQT6hrMi";
    //账号AK信息请填写(必选)
    private static final String accessKeySecret = "BDssg5woyyCJCUh764CYh57UOlgU4L";
